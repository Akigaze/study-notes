...
- 每个类的对象都有一个 `__dict__` 属性，将对象的属性输出成一个dict
- 而设置了 `__slots__` 属性的类好像有些不一样
...
[**Flask**](https://dormousehole.readthedocs.io/en/latest/), [**Django**](https://www.djangoproject.com/), **web.py**, [**Bottle**](http://bottlepy.org/docs/dev/), [**Tornado**](http://www.tornadoweb.org/en/stable/)
