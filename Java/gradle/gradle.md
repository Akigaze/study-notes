...
![](pic\org.gradle.api.Project.png)
...
![](pic\dependency-manager.png)

### 20.1 DependencyHandler
Gradle 中依赖的种类：  

![](pic\dependency-type.png)
...
![](pic\relation-between-project-and-dependency.png)
...
![](pic\repository-type.png)

Repository 仓库的API：

![](pic\repository-api.png)
